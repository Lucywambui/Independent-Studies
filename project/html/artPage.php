...
<html lang="en">
  <head>
    ...
    <!-- Bootstrap CSS and JS -->
      <link rel="stylesheet" text="text/css" href="../css/artPage.css">
      ...
      <div class="container p-3 my-3">
          ...
          <div class="container-fluid">
              <ul class="nav nav-tabs" style="align-items:center;">
                  ...
                  <li class="nav-item">
                      <a class="nav-link active" href="artPage.php">Art Page</a>
                  </li>
                  <li class="nav-item">
             ...
             <!-- Row that contains the search bar and sort button -->
              ...
              <!-- Column that handles the search-->
                  <div class="col-9">
                    ...
                    <form action="artpiece.php" method="get">
                        <div class="col-9">
                          <input type="text" class="form-control" placeholder="Search for the art piece of your needs" name="search">
                           </div>      
                 ...
                 <!-- Column that handles the sort function -->
                  <div class="col-3">                  
                   ...
                   <!-- Form that handles the sort function nd dropdown -->
                   <form action="artPage.php" method="post" class="dropdownsort">
                   <div class="dropdown">
        ...
        if(isset($_GET['search'])){
       	...
       	//if the search variable is not set then the query to load the normal art page is run 
     ...
     //the result set after the query is completed    
	  ...
	  foreach($result as $row){
	  	 ...
	  	 for($j=0;$j<=$numOfItems;$j++){
             ...
             //first row
              ...
              if($items[$j]['itemName'] != ''){
              	...
              	echo"<form action='artpiece.php' method='get'>";
              	echo "<input type='hidden' class='products' value={$items[$j]['itemID']} name='itemID'>";
              	echo"<input type='image'  class='products' src={$items[$j]['itemImage']}  alt='submit'> ";
              	echo"<input type='text' id='artpiece' class='artpiece'  value={$items[$j]['itemName']} readonly>";
              	echo"</form>";
		...
		echo"<input type='hidden' class= 'products' value={$items[$j]['itemID']} name='itemID'>";
		echo" <input type='image' class='products' src={$items[$j]['itemImage']} alt='submit'>";
		echo "<input type='text' id='artpiece' class='artpiece' method='get'  value={$items[$j]['itemName']} readonly>";
		echo"</form>";
		echo"<p>£ {$items[$j]['price']}</p";
		echo"</div>";
		}
